...
## DIRS
QUERY_DIR = BASE_DIR + "/results/reflex"
...
TIME_SERIES_EXP_QUERY_COMPLEXITY = QUERY_COMPLEXITY_SIMPLE
...
LAYOUT_EXP_INDEX_USAGE_TYPES = [INDEX_USAGE_TYPE_PARTIAL_FAST, INDEX_USAGE_TYPE_NEVER]
