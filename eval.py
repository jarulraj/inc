...
## INDEX USAGES
INDEX_USAGES_ALL = [INDEX_USAGE_AGGRESSIVE, INDEX_USAGE_CONSERVATIVE, INDEX_USAGE_NEVER]
INDEX_USAGES_SUBSET = [INDEX_USAGE_AGGRESSIVE, INDEX_USAGE_CONSERVATIVE]
...
QUERY_EXP_QUERY_COMPLEXITYS = [QUERY_COMPLEXITY_MODERATE, QUERY_COMPLEXITY_COMPLEX]
QUERY_EXP_PHASE_LENGTHS = [50, 100, 500]
QUERY_CSV = "query.csv"
