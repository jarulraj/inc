...
LAYOUT_EXP_COLUMN_COUNT = 1000
LAYOUT_EXP_SELECTIVITIES = [0.01, 0.1]
LAYOUT_EXP_PROJECTIVITIES = [0.001, 0.01]
...
LAYOUT_EXP_VARIABILITY_THRESHOLD = 1
...
def create_holistic_line_chart(datasets):
    ...
    HOLISTIC_OPT_MARKER_FREQUENCY = HOLISTIC_EXP_QUERY_COUNT/15
